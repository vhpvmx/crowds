...
bool initGL(int *argc, char **argv)
{
    ...
    gluPerspective(60.0, (GLfloat)world_width / (GLfloat) world_height, 0.1, 2048.0);  //HPV se cambio de 10 a 1024 el ultimo campo ZFar
    glTranslated(-512, -512, -1536); //HPV Se cambia la longitud de alcance de vision con ZFar y tmb el sistema de coordenadas
